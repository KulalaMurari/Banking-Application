...
<body>
<div class="registerCustomer-container">
    ...
    <form action="RegisterCustomerServlet" method="post">
        ...
        <input type="text" id="mobileNo" name="mobileNo" required pattern="\d{10}" title="Please enter a valid 10-digit mobile number"><br><br>
