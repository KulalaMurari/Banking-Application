...
public class CustomerDAO {
	public void registerCustomer(Customer customer) throws SQLException {
        ...
        String accountQuery = "INSERT INTO accounts (accountNo, customerName, balance) VALUES (?, ?, ?)";
        ...
        try (Connection con = DBConnection.getConnection();
         ...
         // Insert into accounts table
            accountStmt.setString(1, customer.getAccountNo());
            accountStmt.setString(2, customer.getFullName());
            accountStmt.setDouble(3, customer.getInitialBalance());
